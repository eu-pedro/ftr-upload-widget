...
export function UploadWidgetUploadItem({
  ...
  return (
    <motion.div
      ...
      className="p-3 rounded-lg flex flex-col gap-3 shadow-shape-content bg-white/20 relative overflow-hidden"
    >
      <div className="flex flex-col gap-1">
        ...
        <span className="text-xxs text-zinc-400 flex gap-1.5 items-center">
          ...
          <span>
            {formatBytes(upload.compressedSizeInBytes ?? 0)}KB
            {upload.compressedSizeInBytes && (
      ...
      >
        <Progress.Indicator
          className="bg-indigo-500 h-1 group-data-[status=success]:bg-green-400 group-data-[status=canceled]:bg-yellow-400 group-data-[status=error]:bg-red-400 transition-all "
          style={{
